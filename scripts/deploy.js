async function main() {
  ...
  const MyToken = await hre.ethers.getContractFactory("VeganTokenNFT");
  ...
  await nft.safeMint(await signer0.getAddress(), "ipfs://QmZHcUqcv1jurX3zyxFZMdACbcev9g91tLTrSbd3RVvHUe");
